...
public class CraftFluidTag extends CraftTag<net.minecraft.world.level.material.Fluid, Fluid> {
    ...
    public boolean isTagged(Fluid fluid) {
        return registry.getHolderOrThrow(KEY_CACHE.computeIfAbsent(fluid, f -> net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.FLUID, org.bukkit.craftbukkit.v1_19_R2.util.CraftNamespacedKey.toMinecraft(f.getKey())))).is(tag); // Paper - cache key
    }
