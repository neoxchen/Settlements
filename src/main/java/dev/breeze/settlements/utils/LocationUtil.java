...
public class LocationUtil {
    ...
    public static double distanceSquared(Location l1, Location l2) {
        return Math.pow(l1.getX() - l2.getX(), 2) + Math.pow(l1.getY() - l2.getY(), 2) + Math.pow(l1.getZ() - l2.getZ(), 2);
    }

    /**
     * Calculates the coordinates of a Bézier curve at time t
     * - ref: <a href="https://math.stackexchange.com/questions/4173207/how-to-find-a-bezier-curve-between-two-points-and-two-tangents-without-anchor-po">stack exchange</a>
     *
     * @param t       time
