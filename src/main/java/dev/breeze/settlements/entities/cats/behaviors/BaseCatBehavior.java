...
public abstract class BaseCatBehavior extends Behavior<Cat> {
    ...
    @Override
    protected final boolean checkExtraStartConditions(@Nonnull ServerLevel world, @Nonnull Cat entity) {
    ...
    protected abstract boolean checkExtraStartConditionsRateLimited(@Nonnull ServerLevel world, @Nonnull Cat entity);
